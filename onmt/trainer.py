...
def build_trainer(opt, device_id, model, fields, optim, model_saver=None, report_manager=None):
    """
    ...
    report_manager = report_manager or onmt.utils.build_report_manager(opt, gpu_rank)
